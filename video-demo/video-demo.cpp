...
int main(int argsc, char ** argsv)
{
	...
	// Set the appropriate FPS rate of the video to not mess up time
	cv::VideoCapture cap(videoPath);
	if (!cap.isOpened())
	{
		std::cout << "Unable to open video file! Frame rate might be messed up" << std::endl;
	}
	else
	{
